...
ROBOT_HEXARM_SRV = {
    ...
    "cfg": {
        ...
        "params": {
            "control_hz": YOCO["control_hz"],
            "device_ip": YOCO["device"]["robot"]["device_ip"],
            "device_port": YOCO["device"]["robot"]["device_port"],
            "control_hz": 1000,
            "sens_ts": True,
...
def set_mujoco_node_cfg(
    ...
    default_node_params_dict["mujoco_archer_y6_srv"]["cfg"]["params"][
        "headless"] = mujoco_params.get(
            "headless",
            MUJOCO_ARCHER_Y6_SRV["cfg"]["params"]["headless"],
        )
    # robot
    default_node_params_dict["mujoco_archer_y6_srv"]["cfg"]["params"][
        "mit_kp"] = robot_params.get(
            "mit_kp",
            MUJOCO_ARCHER_Y6_SRV["cfg"]["params"]["mit_kp"],
        )
    default_node_params_dict["mujoco_archer_y6_srv"]["cfg"]["params"][
        "mit_kd"] = robot_params.get(
            "mit_kd",
            MUJOCO_ARCHER_Y6_SRV["cfg"]["params"]["mit_kd"],
        )
...
def set_robot_node_cfg(
    ...
    # params
    default_node_params_dict["robot_archer_y6_srv"]["cfg"]["params"][
        "arm_type"] = robot_params.get(
            "arm_type",
    ...
    # device
    default_node_params_dict["robot_archer_y6_srv"]["cfg"]["params"][
        "device_ip"] = robot_device.get(
            "device_ip",
            ROBOT_HEXARM_SRV["cfg"]["params"]["device_ip"],
        )
    default_node_params_dict["robot_archer_y6_srv"]["cfg"]["params"][
        "device_port"] = robot_device.get(
            "device_port",
...
def set_rgb_node_cfg(
    ...
    default_node_params_dict["camera_archer_y6_srv"]["cfg"]["params"][
        "exposure"] = rgb_params.get(
            "exposure",
            RGB_SRV["cfg"]["params"]["exposure"],
        )
    default_node_params_dict["camera_archer_y6_srv"]["cfg"]["params"][
        "temperature"] = rgb_params.get(
            "temperature",
            RGB_SRV["cfg"]["params"]["temperature"],
        )
    # device
    default_node_params_dict["camera_archer_y6_srv"]["cfg"]["params"][
        "cam_path"] = rgb_device.get(
            "cam_path",
...
def set_realsense_node_cfg(
    ...
    # params
    default_node_params_dict["camera_archer_y6_srv"]["cfg"]["params"][
        "resolution"] = realsense_params.get(
            "resolution",
            REALSENSE_SRV["cfg"]["params"]["resolution"],
        )
    # device
    default_node_params_dict["camera_archer_y6_srv"]["cfg"]["params"][
        "serial_number"] = realsense_device.get(
            "serial_number",
...
def set_berxel_node_cfg(
    ...
    # params
    default_node_params_dict["camera_archer_y6_srv"]["cfg"]["params"][
        "exposure"] = berxel_params.get(
            "exposure",
            BERXEL_SRV["cfg"]["params"]["exposure"],
        )
    default_node_params_dict["camera_archer_y6_srv"]["cfg"]["params"][
        "gain"] = berxel_params.get(
            "gain",
...
def get_node_cfgs(node_params_dict: dict = {}, launch_args: dict = YOCO):
    ...
    if use_sim:
        default_node_params_dict["mujoco_archer_y6_srv"] = copy.deepcopy(
            MUJOCO_ARCHER_Y6_SRV)
        default_node_params_dict["mujoco_archer_y6_srv"]["cfg"]["params"][
            "cam_type"] = cam_type
        ...
        default_node_params_dict["robot_archer_y6_srv"] = copy.deepcopy(
            ROBOT_HEXARM_SRV)
        default_node_params_dict["robot_archer_y6_srv"]["cfg"]["net"][
            "port"] = srv_port.get("robot_port",
                                   YOCO["srv_port"]["robot_port"])
        default_node_params_dict["robot_archer_y6_srv"]["cfg"]["params"][
            "control_hz"] = control_hz
        default_node_params_dict = set_robot_node_cfg(
            default_node_params_dict,
            params.get("robot", YOCO["params"]["robot"]),
            device.get("robot", YOCO["device"]["robot"]),
        )
        # cam_type: empty, rgb, realsense, berxel
        if cam_type == "rgb":
            default_node_params_dict["camera_archer_y6_srv"] = copy.deepcopy(
                RGB_SRV)
            ...
            default_node_params_dict = set_rgb_node_cfg(
                ...
                device.get("camera", YOCO["device"]["camera"]),
            )
        elif cam_type == "realsense":
            if _HAS_REALSENSE:
                default_node_params_dict[
                    "camera_archer_y6_srv"] = copy.deepcopy(REALSENSE_SRV)
                default_node_params_dict["camera_archer_y6_srv"]["cfg"]["net"][
                    "port"] = srv_port.get("camera_port",
                                           YOCO["srv_port"]["camera_port"])
            ...
            if _HAS_BERXEL:
                default_node_params_dict[
                    "camera_archer_y6_srv"] = copy.deepcopy(BERXEL_SRV)
                default_node_params_dict["camera_archer_y6_srv"]["cfg"]["net"][
                    "port"] = srv_port.get("camera_port",
                                           YOCO["srv_port"]["camera_port"])
                default_node_params_dict = set_berxel_node_cfg(
                    default_node_params_dict,
                    params.get("camera", YOCO["params"]["berxel"]),
                    device.get("camera", YOCO["device"]["camera"]),
                )
        elif cam_type == "empty":
            pass
